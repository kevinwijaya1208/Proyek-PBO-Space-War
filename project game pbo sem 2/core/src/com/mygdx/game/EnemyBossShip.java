...
public class EnemyBossShip extends EnemyShip{
    Random random = new Random();
    Vector2 directionVector;

    public EnemyBossShip(float xPosition, float yPosition, float width, float height, int health, float movementSpeed, int score, Texture shipTexture, Texture laserTexture) {
